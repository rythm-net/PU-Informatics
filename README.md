...
<table align="center">
    ...
    <tbody>
        ...
        <tr>
            <td><a href="III курс/I семестър/Алгоритми и структури от данни C#">Алгоритми и структури от данни C#</a></td>
        ...
        <tr>
            <td><a href="II курс/I семестър/Разпределени приложения C#">Разпределени приложения C#</a>
                <ul>
                  <li><a href="https://github.com/rythm-net/WebApiJwt/">Курсов Проект</a></li>
                </ul>
            </td>
            <td><a href="II курс/II семестър/Компютърна графика">Компютърна графика</a>
                <ul>
        ...
        <tr>
            ...
            <td><a href="II курс/I семестър/Шаблони за проектиране Java">Шаблони за проектиране Java</a>
                <ul>
